...
const allMotQuote = [
  {
    quote:
      "Discipline is choosing between what you are now and what you want most.",
    author: "Abraham Lincoln",
  },
  {
    quote:
      "Success grows quietly from the small promises you keep to yourself each day.",
    author: "Robin Sharma",
  },
  {
    quote:
      "Your future is shaped more by your habits than by your hopes or dreams.",
    author: "James Clear",
  },
  {
    quote:
      "The hardest step toward success is often the decision to begin today.",
    author: "John C. Maxwell",
  },
  {
    quote:
      "Great achievements are built from ordinary actions repeated with extraordinary consistency.",
    author: "Darren Hardy",
  },
  {
    quote:
      "You become stronger every time you choose progress over comfort and excuses.",
    author: "Mel Robbins",
  },
  {
    quote:
      "Dreams remain wishes until daily effort transforms them into lasting reality.",
    author: "Les Brown",
  },
  {
    quote:
      "Every meaningful victory begins with a mindset that refuses to surrender easily.",
    author: "Tony Robbins",
  },
  {
    quote:
      "Confidence is earned by keeping the commitments you make to yourself consistently.",
    author: "Brian Tracy",
  },
  {
    quote:
      "Time rewards those who invest it wisely instead of spending it carelessly.",
    author: "Jim Rohn",
  },
  {
    quote:
      "Your greatest competition is the person you were yesterday, not anyone else.",
    author: "Unknown",
  },
  {
    quote:
      "Small improvements practiced every day eventually create results that seem impossible.",
    author: "James Clear",
  },
  {
    quote:
      "Courage is moving forward even when fear insists that you should stop.",
    author: "Nelson Mandela",
  },
  {
    quote:
      "The quality of your life reflects the quality of your daily decisions.",
    author: "Stephen R. Covey",
  },
  {
    quote:
      "Consistency will carry you farther than motivation ever promises to take you.",
    author: "Zig Ziglar",
  },
];
